...
**Figura.** *MSE de evaluación de medidas de inflación basadas en percentiles utilizando criterios básicos*. 
![Evaluacion percentiles agosto 2020](images/percentiles/2020-10-05-15-38-15.png)
...
**Figura.** *Descomposición aditiva del MSE de evaluación de medidas de inflación basadas en percentiles utilizando criterios básicos*. 
![Descomposición aditiva MSE evaluación](images/percentiles/2020-10-06-10-19-35.png)
...
En esta sección se presentan los análisis de sensbilidad obtenidos en el ejercicio de evaluación de las medidas de inflación basadas en percentiles. 
...
![Evaluacion percentiles análisis sensibilidad períodos](images/percentiles/2020-10-05-15-41-46.png)
...
![Evaluacion percentiles análisis sensibilidad medida evaluación](images/percentiles/2020-10-05-15-42-40.png)
...
![Evaluacion percentiles análisis sensibilidad subperíodo evaluación](images/percentiles/2020-10-05-15-44-42.png)
...
![Evaluacion percentiles análisis sensibilidad tendencia](images/percentiles/2020-10-05-15-46-23.png)
...
![Evaluacion percentiles análisis sensibilidad parámetro poblacional](images/percentiles/2020-10-05-15-47-07.png)
...
![Evaluacion percentiles análisis sensibilidad muestreo bootstrap](images/percentiles/2020-10-05-15-48-02.png)
...
**Figura.** *Distribuciones de simulación del MSE de los percentiles óptimos con criterio basicos*.
![Distribuciones de simulación MSE percentles óptimos criterio basico](images/percentiles/2020-10-05-15-48-32.png)
...
**Figura.** *Distribuciones de simulación del MSE de los percentiles óptimos con criterio basicos, por tipo de tendencia aplicada en la evaluación*.
![Distribuciones de simulación MSE percentles óptimos por tipo tendencia](images/percentiles/2020-10-05-15-49-54.png)
...
**Figura.** *Distribuciones de simulación del MSE de los percentiles óptimos con criterio basicos, por subperíodo de evaluación*.
![Distribuciones de simulación MSE percentles óptimos por subperíodo](images/percentiles/2020-10-05-15-50-28.png)
...
![Análisis de trayectorias de datos históricamente observados](images/percentiles/2020-10-05-15-51-40.png)